    ...
    <section className="bg-white text-gray-800">
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-12 items-start leading-relaxed">
        ...
        <div className="space-y-6 text-justify">
          ...
          <p className="mt-6 text-lg">
            Kami menangani setiap kasus dengan perhatian mendetail dan pemahaman
            mendalam terhadap hukum. Komitmen kami terhadap keunggulan
            memastikan Anda mendapatkan representasi dengan kualitas terbaik.
          </p>

          <p className="mt-6 text-lg">
            Keyakinan kami adalah bahwa keadilan harus dapat diakses dan dapat
            dipercaya oleh semua orang. kesuksesan dan keamanan Anda akan selalu
