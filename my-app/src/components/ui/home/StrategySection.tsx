      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="order-2 lg:order-1">
            <p className="text-amber-600 font-extrabold tracking-wide uppercase mb-2 text-sm sm:text-base">
              Strategi Kami
            </p>
              ...
              {tabs.map((tab) => (
                <button
                  ...
                  className={`text-sm sm:text-lg font-medium transition relative cursor-pointer py-2 px-1 sm:px-0 ${
                    activeTab === tab.name
                      ? "text-amber-600 font-semibold after:absolute after:-bottom-[1px] after:left-0 after:h-[2px] after:w-full after:bg-amber-600"
          ...
          <div className="relative order-1 lg:order-2 mb-8 lg:mb-0">
            ...
            <div className="absolute top-0 right-0 bg-amber-500/70 rounded-full w-40 h-40 sm:w-45 sm:h-45 md:w-55 md:h-55 lg:w-65 lg:h-65 -translate-x-2 -translate-y-2 sm:-translate-x-2 sm:-translate-y-2 md:-translate-x-35 md:-translate-y-2 lg:-translate-x-0 lg:-translate-y-10"></div>

            {/* Border decoration - Adjusted for mobile */}
            <div className="hidden sm:block absolute top-4 -left-4 sm:top-8 sm:-left-8 w-24 h-32 sm:w-32 sm:h-40 lg:w-130 lg:h-162 border border-zinc-200 rounded-tr-[50px] lg:rounded-tr-[100px]"></div>
            ...
            <div className="sm:hidden absolute -bottom-4 -right-4 bg-amber-500 rounded-full w-12 h-12 opacity-20"></div>
          </div>
        </div>
      </div>
    </section>
